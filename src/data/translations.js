export const translations = {
    ...
    tr: {
        ...
        contact: {
            title: 'İletişime Geç',
            subtitle: "Konuşalım",
            desc: "Şu anda freelance işler için uygunum ve yeni fırsatlara açığım. Bir sorunuz varsa veya sadece merhaba demek istiyorsanız, size en kısa sürede dönüş yapmaya çalışacağım!",
            form: {
                name: 'İsim',
                email: 'E-posta',
                message: 'Mesaj',
    ...
    ar: {
        ...
        contact: {
            title: 'تواصل معي',
            subtitle: "لنتحدث",
            desc: "أنا متاح حالياً للعمل الحر ومنفتح على فرص جديدة. سواء كان لديك سؤال أو ترغب فقط في إلقاء التحية، سأبذل قصارى جهدي للرد عليك!",
            form: {
                name: 'الاسم',
