...
try {
    ...
    $stmt->execute(["tr", "Ayşe Demir", "Ürün Müdürü", "StartUp Inc", "Yaratıcı çözümleri ve teknik bilgisiyle projemize değer kattı. Kesinlikle tavsiye ederim.", "https://randomuser.me/api/portraits/women/44.jpg"]);
    $stmt->execute(["tr", "Caner Erkin", "Kurucu", "Digital Agency", "Hızlı, güvenilir ve profesyonel. Beklentilerimizin çok ötesinde bir iş çıkardı.", "https://randomuser.me/api/portraits/men/85.jpg"]);
    ...
    // DE
    $stmt->execute(["de", "Hans Müller", "CTO", "TechCorp", "Die Zusammenarbeit mit Ahmet war großartig. Er hat unser Projekt pünktlich und in hervorragender Qualität geliefert.", "https://randomuser.me/api/portraits/men/32.jpg"]);
    $stmt->execute(["de", "Julia Weber", "Produktmanagerin", "StartUp Inc", "Hat mit kreativen Lösungen und technischem Wissen einen Mehrwert für unser Projekt geschaffen. Absolut empfehlenswert.", "https://randomuser.me/api/portraits/women/44.jpg"]);
    $stmt->execute(["de", "Klaus Wagner", "Gründer", "Digital Agency", "Schnell, zuverlässig und professionell. Hat eine Arbeit geleistet, die weit über unseren Erwartungen lag.", "https://randomuser.me/api/portraits/men/85.jpg"]);

    // AR
    $stmt->execute(["ar", "أحمد حسن", "المدير التقني", "تيك كورب", "كان العمل مع أحمد رائعًا. سلم مشروعنا في الوقت المحدد وبجودة ممتازة.", "https://randomuser.me/api/portraits/men/32.jpg"]);
    $stmt->execute(["ar", "ليلى محمود", "مديرة المنتج", "ستارت أب", "أضاف قيمة لمشروعنا بحلوله الإبداعية ومعرفته التقنية. أوصي به بشدة.", "https://randomuser.me/api/portraits/women/44.jpg"]);
    $stmt->execute(["ar", "عمر خالد", "المؤسس", "وكالة رقمية", "سريع وموثوق ومحترف. قدم عملاً يفوق توقعاتنا بكثير.", "https://randomuser.me/api/portraits/men/85.jpg"]);

    // RU
    $stmt->execute(["ru", "Дмитрий Волков", "CTO", "TechCorp", "Работать с Ахметом было здорово. Он сдал наш проект вовремя и с отличным качеством.", "https://randomuser.me/api/portraits/men/32.jpg"]);
    $stmt->execute(["ru", "Елена Соколова", "Менеджер продукта", "StartUp Inc", "Добавил ценность нашему проекту своими творческими решениями и техническими знаниями. Настоятельно рекомендую.", "https://randomuser.me/api/portraits/women/44.jpg"]);
    $stmt->execute(["ru", "Алексей Морозов", "Основатель", "Digital Agency", "Быстро, надежно и профессионально. Сделал работу, превосходящую наши ожидания.", "https://randomuser.me/api/portraits/men/85.jpg"]);
    ...
    $stmtBlog->execute([
        ...
        "moderne-webentwicklungstrends-2025",
        "Technologien und Ansätze, die 2025 in der Welt der Webentwicklung hervorstechen.",
    ...
    $stmtBlog->execute([
        "de",
        "Programmieren mit Antigravity: Die Zukunft der KI",
        "programmieren-mit-antigravity",
        "Entdecken Sie die Fähigkeiten von Googles fortschrittlichem KI-Coding-Assistenten Antigravity und wie er den Entwicklungsprozess revolutioniert.",
    ...
    $stmtBlog->execute([
        "ar",
        "اتجاهات تطوير الويب الحديثة 2025",
        "modern-web-development-trends-2025-ar",
        "التقنيات والمناهج التي تبرز في عالم تطوير الويب في عام 2025.",
    ...
    $stmtBlog->execute([
        "ar",
        "البرمجة مع Antigravity: مستقبل الذكاء الاصطناعي",
        "coding-with-antigravity-ar",
        "استكشاف قدرات مساعد البرمجة بالذكاء الاصطناعي المتقدم من Google، Antigravity، وكيف يحدث ثورة في سير عمل التطوير.",
        "# البرمجة مع Antigravity\n\nمساعدو البرمجة بالذكاء الاصطناعي يفعلون الآن أكثر من مجرد إكمال التعليمات البرمجية. يمكن للأنظمة المتقدمة مثل Antigravity إدارة مشاريع بأكملها.\n\n## الميزات\n- كتابة التعليمات البرمجية بشكل مستقل تمامًا\n- إدارة المشاريع\n- إصلاح الأخطاء\n\nالتفاصيل قريبا...",
        "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?q=80&w=600&auto=format&fit=crop",
        "الذكاء الاصطناعي"
    ]);
    ...
    $stmtBlog->execute([
        "ru",
        "Тренды современной веб-разработки 2025",
        "modern-web-development-trends-2025-ru",
        "Технологии и подходы, выделяющиеся в мире веб-разработки в 2025 году.",
    ...
    $stmtBlog->execute([
        "ru",
        "Программирование с Antigravity: Будущее ИИ",
        "coding-with-antigravity-ru",
        "Изучение возможностей передового ИИ-ассистента по программированию от Google, Antigravity, и того, как он революционизирует процесс разработки.",
        "# Программирование с Antigravity\n\nИИ-ассистенты теперь делают больше, чем просто автодополнение кода. Передовые системы, такие как Antigravity, могут управлять целыми проектами.\n\n## Особенности\n- Полностью автономное написание кода\n- Управление проектами\n- Исправление ошибок\n\nПодробности скоро...",
        "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?q=80&w=600&auto=format&fit=crop",
        "Искусственный Интеллект"
    ]);

    echo json_encode(["message" => "Database setup completed successfully with Multi-Language support (TR, EN, DE, AR, RU)."]);
